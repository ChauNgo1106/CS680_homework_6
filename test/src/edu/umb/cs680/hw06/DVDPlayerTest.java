...
class DVDPlayerTest {
	...
	@Test
	public void checking_player1_stop_then_play_and_open_close_button_pushed() {
		DVDPlayer player1 = DVDPlayer.getInstance();
		String actual = "";
		String expected = "";
	...
	@Test
	public void checking_player1_play_then_play_then_open_then_stop_and_open_close_button_pushed() {
		DVDPlayer player1 = DVDPlayer.getInstance();
		String actual = "";
		String expected = "";
		...
		actual += player1.openCloseButtonPushed();
		expected += "Drawer is open" + "\n" + "Press: Close" + "\n" + "Drawer is close and CD is not playing";
